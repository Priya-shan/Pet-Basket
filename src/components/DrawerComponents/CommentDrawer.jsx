...
function CommentDrawer({ isOpen, onClose, postId }) {
            ...
            <DrawerOverlay>
                <DrawerContent>
                    ...
                    <DrawerFooter flexDirection={'column'}>
                        {showReplySection && (
                            <Flex>
                                <Input name="reply" placeholder="Add Reply" value={replyText} onChange={handleInputChange} mr={2} />
                                <Button w={"200px"} size="sm" onClick={() => postReply(selectedCommentId)}>
                                    Post Reply
                                </Button>
                            </Flex>
                        )}
                        <Spacer my={2}></Spacer>
                        <Flex>
                            <Input name="comment" placeholder="Add Comment" value={commentText} mr={2} onChange={handleInputChange} />
                            <Button w={"200px"} size="sm" onClick={() => postComment(comments.postId)}>
                                Post Comment
                            </Button>
                        </Flex>
