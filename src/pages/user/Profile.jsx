...
import { Center, HStack, VStack, FormControl, FormLabel,IconButton } from '@chakra-ui/react';
...
function Profile() {
    ...
    return (
        < >
            ...
            <Flex backgroundImage={BackgroundImage} style={{ backgroundAttachment: 'fixed' }} height={"100vh"}>
                ...
                <Box p={4} width={"100%"}>
                    ...
                    {/* Main Section */}
                    <Flex flexWrap="wrap" justifyContent={'space-between'} mx={3}>
                        {/* Post Images */}
                        ...
                        {/* </Box> */}
                        {posts.length > 0 && posts.map((post, index) => (
                            <Box bg="gray.200" h={{ base: "85px", md: "150px", lg: "230px" }} w={{ base: "85px", md: "150px", lg: "295px" }} my={1}>
                                <Image
